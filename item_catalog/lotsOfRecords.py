...
genre2 = Genre(genre_name="R&B", description='Rhythm and blues, often abbreviated as R&B or RnB, is a genre of popular African-American music that originated in the 1940s.',
               genre_image='http://i.imgur.com/2OVemx8.jpg')
session.add(genre2)
...
genre6 = Genre(genre_name="Metal",
               description='Heavy metal (or simply metal) is a genre of rock music[1] that developed in the late 1960s and early 1970s, largely in the United Kingdom and the United States. With roots in blues rock and psychedelic rock,the bands that created heavy metal developed a thick, massive sound, characterized by highly amplified distortion, extended guitar solos, emphatic beats, and overall loudness.', genre_image='http://i.imgur.com/GkVIiRu.jpg')
session.add(genre6)
...
artist1 = Artist(artist_name='Miles Davis', genre_id=1,
                 artist_image='http://i.imgur.com/EljvyDY.jpg')
session.add(artist1)

artist2 = Artist(artist_name='Leon Bridges', genre_id=2,
                 artist_image='http://i.imgur.com/naeXlX1.jpg')
session.add(artist2)

artist3 = Artist(artist_name='Nas', genre_id=3,
                 artist_image='http://i.imgur.com/LbrPvjr.jpg')
session.add(artist3)

artist4 = Artist(artist_name='Sturgill Simpson', genre_id=4,
                 artist_image='http://i.imgur.com/B9DTjJT.jpg')
session.add(artist4)

artist5 = Artist(artist_name='Neutral Milk Hotel', genre_id=5,
                 artist_image='http://i.imgur.com/AU3JtHN.jpg')
session.add(artist5)

artist6 = Artist(artist_name='Led Zeppelin', genre_id=6,
                 artist_image='http://i.imgur.com/GbPVHdv.jpg')
session.add(artist6)

artist7 = Artist(artist_name='Bob Marley', genre_id=7,
                 artist_image='http://i.imgur.com/OBpbaf4.jpg')
session.add(artist7)

artist8 = Artist(artist_name='Tyler Bates', genre_id=8,
                 artist_image='http://i.imgur.com/OxUM6fk.jpg')
session.add(artist8)

artist9 = Artist(artist_name='Nujabes', genre_id=9,
                 artist_image='http://i.imgur.com/iI9wNe8.jpg')
session.add(artist9)

artist10 = Artist(artist_name='Parquet Courts', genre_id=10,
                  artist_image='http://i.imgur.com/QOlfP08.jpg')
...
session.add(record8)
record9 = Record(title='Samurai Champloo [Vinyl Double LP] Soundtrack', artist_id=9, genre_id=9, year=2010,
                 description='''Triple vinyl set of hip hop electronica from Fat Jon, Force Of Nature, Nujabes, and Tsutchie from the popular anime series that mixes hip hop culture and music with Japanese samurai culture. Full pic sleeve. Out of print since early 2008 now available again.''', record_image='http://i.imgur.com/B3bVRBG.jpg')
session.add(record9)

record10 = Record(title='Human Performance', artist_id=10, genre_id=10, year=2016,
                  description='THuman Performance is the fifth studio album by American punk rock band Parquet Courts, released on April 8, 2016 on Rough Trade Records', record_image='http://i.imgur.com/jxl5iwE.jpg')
