...
#Test Genres
genre1 = Genre(genre_name = "Jazz", description='', genre_image)
session.add(genre1)

genre2 = Genre(genre_name = "R&B", description='', genre_image)
session.add(genre2)

genre3 = Genre(genre_name = "Hip-Hop", description='', genre_image)
session.add(genre3)

genre4 = Genre(genre_name = "Country", description='', genre_image)
session.add(genre4)

genre5 = Genre(genre_name = "Alt-Rock", description='', genre_image)
session.add(genre5)

genre6 = Genre(genre_name = "Metal", description='', genre_image)
session.add(genre6)

genre7 = Genre(genre_name = "Reggae", description='', genre_image)
session.add(genre7)

genre8 = Genre(genre_name = "Soundtrack", description='', genre_image)
session.add(genre8)

genre9 = Genre(genre_name = "J-Pop", description='', genre_image)
session.add(genre9)

genre10 = Genre(genre_name = "K-Pop", description='', genre_image)
session.add(genre10)
